...
var inputFolder = "Q:/Research/Images(new)/MuseumSpecimens/KHD/To_Be_Compressed"; // Replace with actual input folder path
var outputFolder = "Q:/Research/Images(new)/MuseumSpecimens/KHD/To_Be_Compressed/JPEG"; // Replace with actual output folder path
